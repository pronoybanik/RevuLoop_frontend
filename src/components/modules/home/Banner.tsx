                ...
                <div className="relative max-w-2xl">
                  ...
                  <div className="relative bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                    <div className="flex items-center">
                      ...
                      <input
                        type="text"
                        className="flex-1 px-2 py-6 text-lg text-gray-900 placeholder-gray-500 bg-transparent border-none outline-none"
                        placeholder={text}
                        value={searchQuery}
                        onChange={(e) => setSearchQuery(e.target.value)}
                      />
                      <div className="p-2">
                        <SecondaryButton className="px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200">
                          {isLoading ? (
